...
Run with "python run.py". To augment your own modules with a hebbian mask simply wrap the HebbMask around it: E.G. HebbMask(nn.Linear(128, 10, bias=True), ['weight'])
