...
class RandomNet(nn.Module):
    def __init__(self):
        ...
        self.hebb_classifier1 = nn.Linear(128, 128, bias=True)
        self.hebb_classifier2 = HebbMask(nn.Linear(128, 10, bias=True), ['weight'])
    ...
    def forward(self, x):
        ...
        x = self.hebb_classifier1(x)
        x = self.hebb_classifier2(x)
        return x